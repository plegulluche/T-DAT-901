...
import DefaultArticleNumber from "../component/defaultArticleNumber";
...
export default function Settings({ }) {
    ...
    const onSaveNumber = () => {
        const request = requests.PostUserPreferencesByUserId
        .replace('{count}', count)
        axios.post(request)
                    ...
                    <div className="flex flex-col items-center p-5 bg-[#3A3A3A] rounded-xl">
                        ...
                        <div className="w-full px-5">
                            <div className="flex justify-between items-center">
                                <p className="text-xl text-gray-300">News to display default number</p>
                               {count && <DefaultArticleNumber onChange={(number) => setCount(number)} count={count}/>}
                            </div>
